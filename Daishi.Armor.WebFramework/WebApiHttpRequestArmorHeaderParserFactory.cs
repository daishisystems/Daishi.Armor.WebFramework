...
namespace Daishi.Armor.WebFramework {
    public class WebApiHttpRequestArmorHeaderParserFactory : HttpRequestArmorHeaderParserFactory {
        private readonly HttpRequestHeaders headers;

        public WebApiHttpRequestArmorHeaderParserFactory(HttpRequestHeaders headers) {
